            ...
            <CardContent className='space-y-4'>
                ...
                <div className='space-y-2'>
                    ...
                    >
                        ...
                        <SelectContent>
                            <SelectItem value='A'>
                                Tarif A - {TARIFFS.A}€/km
                            </SelectItem>
                            <SelectItem value='B'>
                                Tarif B - {TARIFFS.B}€/km
                            </SelectItem>
                            <SelectItem value='C'>
                                Tarif C - {TARIFFS.C}€/km
                            </SelectItem>
                            <SelectItem value='D'>
                                Tarif D - {TARIFFS.D}€/km
                            </SelectItem>
                        </SelectContent>
                    </Select>
                </div>
                        ...
                        <CardContent className='pt-6'>
                            <div className='space-y-2 text-sm'>
                                ...
                                {parseFloat(waitingTime) > 0 && (
                                    <div className='flex justify-between'>
                                        <span>
                                            Attente ({waitingTime}min ×{' '}
                                            {(
                                                WAITING_RATE_PER_HOUR / 60
                                            ).toFixed(2)}
                                            €/min):
                                        </span>
                                        <span>
                                            {(
                                                (parseFloat(waitingTime) / 60) *
